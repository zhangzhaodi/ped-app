...
module.exports = {
  dev: {
    ...
    proxyTable: {
      // "/transfer": {
      //   target: "http://192.168.1.100:8088", //接口域名
      //   changeOrigin: true, //是否跨域
      //   pathRewrite: {
      //     "^/transfer": "" //需要rewrite重写的
      //   }
      // },
      // "/myAccount": {  
      //   target: "http://192.168.1.101:8088", //接口域名
      //   changeOrigin: true, //是否跨域
      //   pathRewrite: {
      //     "^/myAccount": "" //需要rewrite重写的
      //   }
      // },
      // "/api": {
      //   target: "http://192.168.1.101:8088", //接口域名
      //   changeOrigin: true, //是否跨域
      //   pathRewrite: {
      //     "^/api": "http://192.168.1.101:8088" //需要rewrite重写的
      //   }
      // }
    },
    // proxyTable: [
    ...
    //     context: "/mock",
    //     // 代理的后台地址
    //     target: "http://192.168.1.100:8088", // 示例而已，自行按需修改
    //     pathRewrite: { "/mock": "" },
    //     changeOrigin: true
    //   }
    // ],
