...
export default {
  ...
  created() {
    if (this.loginInfo) {
      ...
      this.phone = this.loginInfo.MobilePhone;
    }
  ...
  methods: {
    ...
    SendSmsPwd() {
      let params = {
        ...
        // PhoneNbr: "15238355538",
        // MobilePhone: "15238355538"
      };
      this.request("SendSmsOtp", params, true)
        .then(res => {
